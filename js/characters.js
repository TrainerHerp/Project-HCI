...
$('.albedo_modal').click(function() {  
    ...
    $("#story_modal").text("An alchemist, in the service of the Knights of Favonius.\"Genius,\" \"Kreideprinz,\" or \"Captain of the Investigation Team\"... Such titles and honors are of no consequence to him when there is so much more research to conduct.");
});
...
$('.jean_modal').click(function() {  
    ...
    $("#story_modal").text("As the Acting Grand Master of the Knights, Jean has always been devoted to her duties and maintaining peace . She had taken precautions long before the onset of Stormterror's assault, and she will guard her kingdom with her life as always.");
});
...
$('.amber_modal').click(function() {  
    ...
    $("#story_modal").text("A perky, straightforward girl, who is also the only Outrider of the Knights of Favonius. Her amazing mastery of the glider has made her a three-time winner of the Gliding Championship . As a rising star within the Knights of Favonius, Amber is always ready for any challenging tasks.");
});
...
$('.bennett_modal').click(function() {  
    ...
    $("#story_modal").text("The few young adventurers that the Kingdom Adventurers' Guild has always found themselves tangled up in baffling bouts of bad luck. He is the only active member of his own adventure group, known as \"Benny's Adventure Team,\" after all the other members decided to \"take leave\" following a series of unfortunate incidents.  ");
});
...
$('.chongyun_modal').click(function() {  
    ...
    $("#story_modal").text("An exorcist who roams the land as his base of operations, evil spirits fleeing wherever he goes. As the heir to a clan of exorcists, he has always possessed abilities superior to most. However, these abilities are not the result of training, but of an inborn trait - a pure yang spirit.");
});
...
$('.xiao_modal').click(function() {  
    ...
    $("#story_modal").text("One of the mighty and illuminated adepti , also heralded as the \"Vigilant Yaksha.\"Despite his youthful appearance, tales of his exploits have been documented for millennia.He is especially fond of Wangshu Inn's Almond Tofu.This is because it tastes just like the sweet dreams he used to devour.");
});

$('.beldou_modal').click(function() {  
    modalBg.classList.add('bg-active');
    document.getElementById("modal").style.backgroundImage = "url('../assets/dark_modal_background.jpg')";
    $("#name_modal").text("Beidou")
    $("#img_modal").attr("src","../Assets/beldou_modal.png");
    $("#story_modal").text("Captain of the Crux. There are those who say she can split mountains and part the sea. Others say she draws lightning through her sword. Some say that even the mightiest of sea beasts are no match for her.");
});
...
$('.diluc_modal').click(function() {  
    ...
    $("#story_modal").text(" Diluc always presents himself as the epitome of perfection. But behind the courteous visage burns a zealous soul that has sworn to protect Mondstadt at all costs, allowing him to mercilessly vanquish all who threaten his city.");
});
...
$('.fischl_modal').click(function() {  
    ...
    $("#story_modal").text("A mysterious girl who calls herself \"Prinzessin der Verurteilung\" and travels with a night raven named Oz. Currently serves as an investigator in the Adventurers' Guild. Through her unique abilities, eccentric character, and hard work, Fischl has become a rising star among the Adventurers' Guild's investigators");
});
...
$('.mona_modal').click(function() {  
    ...
    $("#story_modal").text("A mysterious young astrologer who proclaims herself to be \"Astrologist Mona Megistus,\" and who possesses abilities to match the title. Erudite, but prideful. Though she is often strapped for cash and lives a life of thrift, she is resolved to never use astrology for profit");
});
